...
# Extracting data with the Scopus API
...
#' # Cleaning scopus data from csv files
...
#' ## Matching references together to give them ID
#'
#' There are several ways we want to identify a common reference:
...
# From here, preparing a cleaning of journal and re-running the process
